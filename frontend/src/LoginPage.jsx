...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center relative font-poppins text-white from-indigo-900 via-purple-900 to-black">
      {/* Login Form Box */}
      <div className="relative border-white border-opacity-20 hover:border-opacity-40 border-[0.5px] bg-opacity-95 rounded-xl pl-10 pr-10 pt-5 pb-10 max-w-md w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium mb-2 hover:border[1px] hover:border-white">Password</label>
            <input
              type="password"
